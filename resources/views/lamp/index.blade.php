                                ...
                                <div class="me-sm-2">
                                    ...
                                    <select class="form-select my-1 my-lg-0" id="status-select" name="type" onchange="this.form.submit()">
                                        ...
                                        @foreach($lamp_types as $lamp_type)
                                            <option value="{{ $lamp_type->id }}" @if($request->type == $lamp_type->id) selected @endif>{{ $lamp_type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="me-sm-2">
                                ...
                                <div class="col-auto"  style="margin-top: 28px;">
                                    <div class="text-lg-end my-1 my-lg-0">
                                        ...
                                        <a href="{{ route('lamp.create') }}">
                                            <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#custom-modal"><i class="mdi mdi-plus-circle me-1"></i>新增平安燈</button>
                                        </a>
                                    </div>
                                </div><!-- end col-->
                            </form>
                                    ...
                                    <td>
                                        <div class="btn-group dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <a class="dropdown-item" href="{{ route('lamp.edit',$data->id) }}"><i class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i>編輯</a>
                                                <a class="dropdown-item" href="{{ route('lamp.del',$data->id) }}"><i class="mdi mdi-delete me-2 font-18 text-muted vertical-middle"></i>刪除</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
