@extends('layouts.vertical', ["page_title"=> "年度其他服務統計"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">年度其他服務統計</li>
                    </ol>
                </div>
                <h4 class="page-title">年度其他服務統計</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form class="d-flex flex-wrap align-items-center" action="{{ route('rpg25') }}" method="GET">
                                    ...
                                    @foreach($proms as $prom)
                                        <tr>
                                            ...
                                            @foreach($datas as $key=>$data)
                                                <td><a href="{{ route('rpg25.detail',['year'=>$request->year,'month'=>$key,'prom_id'=>$prom->id]) }}">{{ $data['proms'][$prom->id]['count'] }} </a></td>
                                            @endforeach
                                            <td>{{ $sums[$prom->id] }}</td>
                                        </tr>
                                    @endforeach
