@extends('layouts.vertical', ['page_title' => '編輯選單'])
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">編輯選單</li>
                        </ol>
                    </div>
                    <h4 class="page-title">編輯選單</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('menu.edit.data',$data->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" data-toggle="select" data-width="100%" name="type">
                                        <option value="main" @if ($data->type == 'main') selected @endif>主要</option>
                                        <option value="app" @if ($data->type == 'app') selected @endif>一般</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select my-1 my-lg-0" id="status-select" name="parent_id">
                                        ...
                                        @foreach ($parent_menus as $parent_menu)
                                            <option value="{{ $parent_menu->id }}" @if ($data->parent_id == $parent_menu->id) selected @endif>{{ $parent_menu->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
