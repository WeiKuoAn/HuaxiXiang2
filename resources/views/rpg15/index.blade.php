                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <form class="d-flex flex-wrap align-items-center" action="{{ route('rpg15') }}"
                                    method="GET">
                                    <div class="me-sm-3">
                                        ...
                                        @foreach ($datas as $data)
                                            <tr align="left">
                                                ...
                                                @foreach ($months as $key => $month)
                                                    <td>
                                                        <span class=" bg-soft-light p-1"
                                                            style="line-height: 35px;">個：{{ $data['months'][$key]['plan_1'] }}單</span><br>
                                                        <span class=" bg-soft-light p-1"
                                                            style="line-height: 35px;">團：{{ $data['months'][$key]['plan_2'] }}單</span><br>
                                                        <span class=" bg-soft-light p-1"
                                                            style="line-height: 35px;">浪：{{ $data['months'][$key]['plan_3'] }}單</span>
                                                    </td>
                                                @endforeach
                                                <td>
                                                    <span class=" bg-soft-warning p-1"
                                                        style="line-height: 35px;">個：{{ $data['total_1'] }}單</span><br>
                                                    <span class=" bg-soft-info p-1"
                                                        style="line-height: 35px;">團：{{ $data['total_2'] }}單</span><br>
                                                    <span class=" bg-soft-light p-1"
                                                        style="line-height: 35px;">浪：{{ $data['total_3'] }}單</span>
                                                </td>
                                            </tr>
                                        @endforeach
