@extends('layouts.vertical', ['page_title' => '編輯後續處理項目'])
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">編輯後續處理項目</li>
                        </ol>
                    </div>
                    <h4 class="page-title">編輯後續處理項目</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('prom_type.edit.data', $data->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">代號<span class="text-danger">*</span></label>
