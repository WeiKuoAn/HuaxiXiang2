                                    ...
                                    @if ($data->pay_id != 'E' && $data->pay_id != 'D')
                                        <div class="mt-2 row">
                                            ...
                                            <div class="col-3">
                                                <select class="form-control" data-toggle="select2" data-width="100%"
                                                    name="old_plan_id" required>
                                                    @if (isset($data->plan_id))
                                                        @foreach ($plans as $plan)
                                                            <option value="{{ $plan->id }}"
                                                                @if ($data->plan_id == $plan->id) selected @endif>
                                                                {{ $plan->name }}</option>
                                                        @endforeach
                                                    @else
                                        ...
                                        <div class="mt-2 row">
                                            @if ($data->pay_id != 'E' && $data->pay_id != 'D')
                                                ...
                                                <div class="col-auto">
                                                    <h4><label class="form-check-label" for="check_change">調整</label></h4>
                                                </div>
                                                <div class="col-3">
                                                    <input type="text" class="form-control" name="new_pay_price"
                                                        value="{{ $data->pay_price }}">
                                                </div>
                                            @else
                                                <div class="col-auto">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-4">
                                        <label for="sale_on" class="form-label">單號<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="sale_on" name="sale_on"
                                            value="{{ $data->sale_on }}" required readonly>
                                    </div>
                                    <div class="mb-3 col-md-4">
                                        <label for="sale_date" class="form-label">日期<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3 col-md-4 not_memorial_show" id="final_price">
                                        <label for="plan_price" class="form-label">收款金額<span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <select class="form-select" name="pay_id" required disabled>
                                            ...
                                            <option value="E" @if ($data->pay_id == 'E') selected @endif>追加
                                            </option>
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <select class="form-select" id="pay_method" name="pay_method" disabled required>
                                            ...
                                            <option value="C" @if ($data->pay_method == 'C') selected @endif>
                                                現金與匯款</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-3" id="transfer_price_div">
                                        ...
                                        <input type="text" class="form-control" id="transfer_price"
                                            name="transfer_price" value="{{ $data->transfer_price }}" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3 col-md-3">
                                        <label for="total" class="form-label">應收金額<span
                                                class="text-danger">*</span></label>
