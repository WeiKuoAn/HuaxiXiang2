...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('sale.data.del', $data->id) }}" method="POST" id="your-form">
            @csrf
            @method('DELETE')
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4 not_final_show not_memorial_show">
                                    <label for="plan_price" class="form-label">方案價格<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $data->plan_price }}" readonly>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4" id="cash_price_div">
                                    <label for="pay_price" class="form-label">現金收款<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $data->cash_price }}" readonly>
                                </div>
                                <div class="mb-3 col-md-4" id="transfer_price_div">
                                    <label for="pay_price" class="form-label">匯款收款<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $data->transfer_price }}" readonly>
                                </div>
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="pay_price" class="form-label">本次收款<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $data->pay_price }}" readonly>
                                </div>
                            </div>
                            <div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center mb-3">
                        ...
                        <button type="submit" class="btn w-sm btn-danger waves-effect waves-light"
                            id="submit_btn" onclick="return confirm('確定要刪除此筆業務資料嗎？此操作無法復原！')">刪除</button>
...
<script src="{{asset('assets/libs/bootstrap-maxlength/bootstrap-maxlength.min.js')}}"></script> --}}
    ...
    <script>
       ...
       $(document).ready(function() {
        ...
        // 處理宗教和往生日期欄位的顯示邏輯
        function handleReligionAndDeathDateFields() {
            ...
            // 根據方案和案件類別決定是否顯示宗教欄位
            if (planId && (typeList === 'memorial' || typeList === 'dispatch')) {
                $('#religion_field').show();
            } else {
                $('#religion_field').hide();
                $('#religion').val('');
        ...
        $(document).ready(function() {
            ...
            // 如果當前是佛道教且有memorial_dates資料，立即顯示
            if (currentReligion === 'buddhism_taoism' && memorialDatesData && memorialDatesData !== 'null') {
                try {
                    var memorialDates = JSON.parse(memorialDatesData);
                    if (memorialDates && memorialDates.sale_id) {
                        $('#memorial_dates_section').show();
            ...
            handleReligionAndDeathDateFields();
