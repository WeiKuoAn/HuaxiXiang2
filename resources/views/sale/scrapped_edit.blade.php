                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="sale_on" name="sale_on" value="{{ str_replace('No.', '', $scrapped->sale_on) }}" required placeholder="請輸入數字" maxlength="10" inputmode="numeric">
                                    </div>
