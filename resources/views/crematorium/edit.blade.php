                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="mt-2">
                                        @if($equipmentType->image_path)
                                            <img id="image_preview" src="{{ asset(str_starts_with($equipmentType->image_path, 'assets/') ? $equipmentType->image_path : 'assets/' . $equipmentType->image_path) }}" alt="" style="max-height:120px; border:1px solid #e9ecef; border-radius:4px;">
                                        @else
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('cost_price') is-invalid @enderror" 
                                           id="cost_price" name="cost_price" value="{{ old('cost_price', $equipmentType->cost_price) }}" min="0" step="0.01">
                                    @error('cost_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
