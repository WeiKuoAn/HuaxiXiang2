                    ...
                    <div class="card-body">
                        <form action="{{ route('crematorium.updateMaintenance', $maintenance->id ?? 0) }}" method="POST">
                                                                ...
                                                                <tr data-equipment-id="{{ $equipment->id }}"
                                                                    ...
                                                                    <td class="text-center">
                                                                        @if (!empty($equipment->equipmentType->image_path))
                                                                            @php
                                                                                $imagePath = str_starts_with($equipment->equipmentType->image_path, 'assets/') ? $equipment->equipmentType->image_path : 'assets/' . $equipment->equipmentType->image_path;
                                                                            @endphp
                            ...
                            <div class="text-end">
                                ...
                                <a href="{{ route('crematorium.equipment.index') }}"
