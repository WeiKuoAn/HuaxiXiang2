                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('category') is-invalid @enderror" 
                                        ...
                                        <option value="furnace_1_ventilation" {{ old('category', $instance->category) == 'furnace_1_ventilation' ? 'selected' : '' }}>一爐抽風</option>
                                        <option value="furnace_2_ventilation" {{ old('category', $instance->category) == 'furnace_2_ventilation' ? 'selected' : '' }}>二爐抽風</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
