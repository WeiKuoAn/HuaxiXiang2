@extends('layouts.vertical', ['page_title' => '新增設備類型'])
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <li class="breadcrumb-item active">新增設備類型</li>
                    </ol>
                </div>
                <h4 class="page-title">新增設備類型（庫存管理）</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('crematorium.equipment.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>說明：</strong>此處管理設備類型和庫存，新增後可在「設備位置管理」中配置各個位置的設備實例。
                            </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="text-muted">例如：熱電偶、點火棒、噴油嘴等</small>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="exclude_from_inventory" 
                                                   ...
                                                   {{ old('exclude_from_inventory') ? 'checked' : '' }}
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('stock_new') is-invalid @enderror"
                                            id="stock_new" name="stock_new" value="{{ old('stock_new', 0) }}" min="0"
                                            oninput="updateStockTotal()">
                                        @error('stock_new')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control @error('stock_usable') is-invalid @enderror"
                                            id="stock_usable" name="stock_usable" value="{{ old('stock_usable', 0) }}" min="0"
                                            oninput="updateStockTotal()">
                                        @error('stock_usable')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_1|fire_1" id="loc_1_1" 
                                                           {{ is_array(old('locations')) && in_array('furnace_1|fire_1', old('locations')) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_1|fire_2" id="loc_1_2"
                                                           {{ is_array(old('locations')) && in_array('furnace_1|fire_2', old('locations')) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_2|fire_1a" id="loc_2_1a"
                                                           {{ is_array(old('locations')) && in_array('furnace_2|fire_1a', old('locations')) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_2|fire_1b" id="loc_2_1b"
                                                           {{ is_array(old('locations')) && in_array('furnace_2|fire_1b', old('locations')) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_2|fire_2" id="loc_2_2"
                                                           {{ is_array(old('locations')) && in_array('furnace_2|fire_2', old('locations')) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_1_ventilation|" id="loc_v_1"
                                                           {{ is_array(old('locations')) && in_array('furnace_1_ventilation|', old('locations')) ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check mb-2">
                                                    <input class="form-check-input" type="checkbox" name="locations[]" value="furnace_2_ventilation|" id="loc_v_2"
                                                           {{ is_array(old('locations')) && in_array('furnace_2_ventilation|', old('locations')) ? 'checked' : '' }}>
                                ...
                                <small class="text-muted">選擇此零件要配置到哪些火化爐位置</small>
                            </div>
                            ...
                            <div class="text-end">
                                ...
                                <button type="submit" class="btn btn-primary">新增設備類型並配置位置</button>
                            </div>
                        </form>
                    </div>
                </div>
