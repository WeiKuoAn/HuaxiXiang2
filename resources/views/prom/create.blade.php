@extends('layouts.vertical', ['page_title' => '新增後續處理細項'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">新增後續處理細項</li>
                        </ol>
                    </div>
                    <h4 class="page-title">新增後續處理細項</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select my-1 my-lg-0" id="status-select" name="type" required>
                                        ...
                                        @foreach ($prom_types as $prom_type)
                                            <option value="{{ $prom_type->code }}">{{ $prom_type->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
