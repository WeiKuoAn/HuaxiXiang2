@extends('layouts.vertical', ["page_title"=> "每月營收報表"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">每月營收報表</li>
                    </ol>
                </div>
                <h4 class="page-title">每月營收報表</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                        ...
                        <table class="table table-centered table-nowrap table-hover mb-0 mt-2">
                            <thead class="table-light">
                                    <tr align="center">
                                        ...
                                        <th scope="col">營收（業務＋其他收入）</th>
                                        <th scope="col">法會收入</th>
                                ...
                                <tr align="center" style="font-weight:bold;" class="text-danger">
                                    ...
                                    <td>{{  number_format($sums['total_puja_price']) }}</td>
                                    @if(Auth::user()->job_id == '1' || Auth::user()->job_id == '6' || Auth::user()->job_id == '7')
                                ...
                                <tbody align="center">
                                    @foreach ($datas as $key=>$data)
                                        <tr>
                                            ...
                                            <td>{{ number_format($data['cur_puja_price']) }}</td>
                                            @if(Auth::user()->job_id == '1' || Auth::user()->job_id == '6' || Auth::user()->job_id == '7')
