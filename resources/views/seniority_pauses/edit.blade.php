@extends('layouts.vertical', ['page_title' => '年資暫停修改'])
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">年資暫停修改</li>
                        </ol>
                    </div>
                    <h4 class="page-title">年資暫停修改</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('SeniorityPauses.edit.data',[$user_id,$id]) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="mb-3">
