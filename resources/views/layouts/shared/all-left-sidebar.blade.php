            ...
            <ul id="side-menu" class="list-unstyled">
                ...
                @if ($mainMenus->count() > 0)
                    ...
                    @foreach ($mainMenus as $parent)
                        ...
                        @endphp
                        <li>
                            <a href="{{ $hasChildren ? '#menu-' . $parent->id : (Route::has($parent->url) ? route($parent->url) : '#') }}"
                                ...
                                <div class="collapse" id="menu-{{ $parent->id }}">
                                    <ul class="nav-second-level list-unstyled">
                                        ...
                                        @foreach ($children as $child)
                                            ...
                                            @endphp
                                            <li>
                                                <a href="{{ $hasGrands ? '#menu-' . $child->id : (Route::has($child->url) ? route($child->url) : '#') }}"
                                                ...
                                                @if ($hasGrands)
                                                    <div class="collapse" id="menu-{{ $child->id }}">
                                                        <ul class="nav-second-level list-unstyled">
                                                            ...
                                                            @foreach ($grands as $grand)
                                                                <li>
                                                                    <a href="{{ Route::has($grand->url) ? route($grand->url) : '#' }}">
                                                                        {{ $grand->name }}
                                                                    </a>
                                                                </li>
                                                            @endforeach
