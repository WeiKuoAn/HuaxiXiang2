                        ...
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('sales.checkHistory') }}"
                                    class="{{ request()->is('sales.checkHistory') ? 'active' : '' }}">查看對帳明細</a>
                            </li>
                        </ul>
                    </div>
                </li>
                        ...
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('income.sujects') }}"
                                    class="{{ request()->is('income.sujects') ? 'active' : '' }}">收入科目</a>
                            </li>
                            <li>
                        ...
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('sources') }}"
                                    class="{{ request()->is('sources') ? 'active' : '' }}">來源資料</a>
                            </li>
                            <li>
                                <a href="{{ route('plans') }}"
                                    class="{{ request()->is('plans') ? 'active' : '' }}">方案資料</a>
                            </li>
                            <li>
                                <a href="{{ route('suits') }}"
                            ...
                            <li>
                                <a href="{{ route('prom_types') }}"
                                    class="{{ request()->is('prom_types') ? 'active' : '' }}">紀念品類別</a>
                            </li>
                            <li>
                                <a href="{{ route('proms') }}"
                                    class="{{ request()->is('proms') ? 'active' : '' }}">紀念品細項</a>
                            </li>
                            <li>
