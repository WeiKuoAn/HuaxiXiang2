@extends('layouts.vertical', ["page_title"=> "套裝法會查詢"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">套裝法會查詢</li>
                    </ol>
                </div>
                <h4 class="page-title">套裝法會查詢</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form class="d-flex flex-wrap align-items-center" id="myForm" action="{{ route('rpg06') }}" method="GET">
                                ...
                                <div class="me-3">
                                    <a href="{{ route('rpg06.export',request()->input()) }}">
