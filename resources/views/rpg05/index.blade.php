                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <form class="d-flex flex-wrap align-items-center" action="{{ route('rpg05') }}"
                                    method="GET">
                                        ...
                                        <tr align="center">
                                            ...
                                            @if (isset($datas[$period->format('Y-m-d')]))
                                                ...
                                                @if (number_format($sums[$period->format('Y-m-d')]['day_total']) < 0)
                                                    <td style="color: red;">
                                                        {{ number_format($sums[$period->format('Y-m-d')]['day_total']) }}
                                                    </td>
                                                @else
                                                    <td>{{ number_format($sums[$period->format('Y-m-d')]['day_total']) }}
                                                    </td>
                                                @endif
                                            @else
                                                <td></td>
