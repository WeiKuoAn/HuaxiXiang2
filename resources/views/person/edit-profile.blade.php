                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" data-toggle="select" data-width="100%" name="education_level">
                            ...
                            <option value="國小或國小以下" @if($user->education_level == '國小或國小以下') selected @endif>國小或國小以下</option>
                            ...
                            <option value="研究所以上" @if($user->education_level == '研究所以上') selected @endif>研究所以上</option>
                        </select>
                    </div>
