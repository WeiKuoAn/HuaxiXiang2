                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-between">
                            <div class="col-auto">
                                <form class="d-flex flex-wrap align-items-center" action="{{ route('person.leave_days') }}"
                                    method="GET">
                                    <div class="me-3">
                                    ...
                                    <div class="me-sm-3">
                                        ...
                                        <select class="form-select my-1 my-lg-0" id="status-select" name="state"
                                            onchange="this.form.submit()">
                                            <option value="1" @if (!isset($request->state) || $request->state == '1') selected @endif>未送出
                                            </option>
                                            <option value="2" @if ($request->state == '2') selected @endif>待審核
                                            </option>
                                    ...
                                    <a href="{{ route('leave_day.create') }}">
                                        <button type="button" class="btn btn-danger waves-effect waves-light"
                                            data-bs-toggle="modal" data-bs-target="#custom-modal"><i
                                                class="mdi mdi-plus-circle me-1"></i>新增假單</button>
                                    </a>
                                </div>
                            </div><!-- end col-->
                        </div> <!-- end row -->
                                                    ...
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                                href="{{ route('leave_day.edit', $data->id) }}"><i
                                                                    class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i>編輯</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('leave_day.del', $data->id) }}"><i
                                                                    class="mdi mdi-delete me-2 text-muted font-18 vertical-middle"></i>刪除</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('person.leave_day.check', $data->id) }}"><i
                                                                    class="mdi mdi-send me-2 font-18 text-muted vertical-middle"></i>送出審核</a>
                                                        </div>
                                                    </div>
                                                @else
                                                    <a href="{{ route('person.leave_day.check', $data->id) }}"><button
                                                            type="button"
