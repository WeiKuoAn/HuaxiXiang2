@extends('layouts.vertical', ['page_title' => '刪除達標類別'])
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">刪除達標類別</li>
                        </ol>
                    </div>
                    <h4 class="page-title">刪除達標類別</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('targetCategory.del.data', $data->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            <label class="form-label">達標類別名稱<span class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            <label class="form-label">達標類別說明<span class="text-danger">*</span></label>
