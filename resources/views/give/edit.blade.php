@extends('layouts.vertical', ['page_title' => '編輯贈送'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">編輯贈送</li>
                        </ol>
                    </div>
                    <h4 class="page-title">編輯贈送</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <form action="{{ route('give.edit.data', $data->id) }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
