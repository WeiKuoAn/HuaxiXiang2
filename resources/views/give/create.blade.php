@extends('layouts.vertical', ['page_title' => '新增贈送'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">新增贈送</li>
                        </ol>
                    </div>
                    <h4 class="page-title">新增贈送</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <form action="{{ route('give.create.data') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control" name="sale_on" value="No." required>
                                </div>
                                <div class="mb-2">
