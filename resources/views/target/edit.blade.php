@extends('layouts.vertical', ['page_title' => '編輯達標'])
    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">編輯達標</li>
                        </ol>
                    </div>
                    <h4 class="page-title">編輯達標</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('target.edit.data', $data->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <!-- 達標類別 -->
                                <div class="col-xl-12">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    <button type="submit" class="btn btn-success waves-effect waves-light m-1">
                                        <i class="fe-check-circle me-1"></i>更新
                                    </button>
