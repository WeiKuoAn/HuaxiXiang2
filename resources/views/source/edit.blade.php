                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="seq"   value="{{ $source->seq }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-toggle="select" data-width="100%" name="status">
                                            <option value="up" @if ($source->status == 'up') selected @endif>上架
                                            </option>
                                            <option value="down" @if ($source->status == 'down') selected @endif>下架
                                            </option>
                                        </select>
                                    </div>
