                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="text-lg-end my-1 my-lg-0">
                                ...
                                <a href="{{ route('personnel.leaves.create') }}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i>新增假別</a>
                                <a href="{{ route('personnel.leavesitting.create') }}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i>新增年度假別天數</a>
                            </div>
                        </div><!-- end col-->
                    </div> <!-- end row -->
                </div>
