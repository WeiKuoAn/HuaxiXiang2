    ...
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">編輯套裝</li>
                        </ol>
                    </div>
                    <h4 class="page-title">編輯套裝</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('suit.edit.data', $suit->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="seq"   value="{{ $suit->seq }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-toggle="select" data-width="100%" name="status">
                                            <option value="up" @if ($suit->status == 'up') selected @endif>上架
                                            </option>
                                            <option value="down" @if ($suit->status == 'down') selected @endif>下架
                                            </option>
                                        </select>
                                    </div>
