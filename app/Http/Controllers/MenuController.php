...
class MenuController extends Controller
{
    public function index()
    {
        ...
        $datas = Menu::whereNull('parent_id')->orderBy('sort', 'asc')->orderBy('created_at', 'asc')->get();
    ...
    public function subMenu($parentId)
    {
        ...
        $datas = Menu::where('parent_id', $parentId)->orderBy('sort', 'asc')->orderBy('created_at', 'asc')->get();
